...
import { User, Mail, Lock, Store, Eye, EyeOff, Sparkles, TrendingUp, Zap, Users, ShieldCheck } from "lucide-react"
...
const SellerSignup = () => {
  ...
  const { sellerSignup, isLoading, error } = useAuthStore()
        ...
        <div className="backdrop-blur-xl bg-black/40 border border-gray-800/50 rounded-2xl overflow-hidden shadow-2xl shadow-[#32cd32]/10">
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              <h1 className="text-white text-3xl font-bold mb-2">Create your dream store</h1>
              <p className="text-gray-400 text-sm">Join our community of successful sellers</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="storeName" className="block text-white text-sm font-medium mb-2">
                  Store Name
                </label>
                <div className="relative">
