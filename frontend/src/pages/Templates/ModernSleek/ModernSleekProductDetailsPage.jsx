// src/pages/Templates/ModernSleek/ModernSleekProductDetailsPage.jsx
"use client"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="flex items-center gap-6">
              ...
              <button onClick={handleAddToCart} className="flex-1 py-4 px-8 font-semibold rounded-sm text-white transition-all duration-300 transform hover:scale-105" style={{ backgroundColor: storeSettings.themeColor }}>
                ADD TO CART
              </button>
            </div>
          </div>
