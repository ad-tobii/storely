// src/pages/Templates/PlayfulColorful/PlayfulColorfulProductDetailsPage.jsx
"use client"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <button onClick={handleAddToCart} className="flex-1 px-8 py-4 rounded-full text-white font-bold text-lg flex items-center justify-center gap-2 transition-transform hover:scale-105" style={{ background: `linear-gradient(135deg, ${storeSettings.themeColor}, ${storeSettings.secondaryColor})` }}>
