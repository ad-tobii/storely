        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <button onClick={handleAddToCart} className="flex-1 py-3 px-6 rounded-md text-white font-medium transition-transform duration-300 transform hover:scale-105" style={{ backgroundColor: storeSettings.themeColor }}>
                Add to Cart
              </button>
            </div>
          </div>
